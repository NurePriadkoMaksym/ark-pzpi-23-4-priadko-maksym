    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FromArticleId = table.Column<int>(type: "int", nullable: false),
                    ToArticleId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleLinks", x => new { x.FromArticleId, x.ToArticleId });
                    table.ForeignKey(
                        name: "FK_ArticleLinks_Articles_FromArticleId",
                        column: x => x.FromArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArticleLinks_Articles_ToArticleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseArticles", x => new { x.CourseId, x.ArticleId });
                    table.ForeignKey(
                        name: "FK_CourseArticles_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseArticles_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserArticleProgresses", x => new { x.UserId, x.ArticleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleLinks_ToArticleId",
                table: "ArticleLinks",
                column: "ToArticleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseArticles_ArticleId",
